package lk.yukon.servicemonitor.configuration;

/**
 * license: BSD - see LICENSE for details
 *
 * ApplicationConstant is for holding application constants
 *
...
public class ApplicationConstant {
    ...
    public static final String CONSTANT_UNSUPPORTED_SERVICE_CONFIGURATION_MANAGER_PARAMETER_MESSAGE="Unsupported service configuration manager parameter :";
